...
func (m *ProcessEvent) GetTimestamp() *timestamp.Timestamp {
	if m != nil {
		return m.Timestamp
	}
	return nil
...
func (m *ProcessEventResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ProcessEventResponse.Unmarshal(m, b)
}
func (m *ProcessEventResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ProcessEventResponse.Marshal(b, m, deterministic)
}
func (m *ProcessEventResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProcessEventResponse.Merge(m, src)
}
func (m *ProcessEventResponse) XXX_Size() int {
	return xxx_messageInfo_ProcessEventResponse.Size(m)
}
func (m *ProcessEventResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ProcessEventResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ProcessEventResponse proto.InternalMessageInfo
...
func (c *processClient) LogProcess(ctx context.Context, in *ProcessEntry, opts ...grpc.CallOption) (*ProcessEntryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.Process/LogProcess", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *processClient) LogEvent(ctx context.Context, in *ProcessEvent, opts ...grpc.CallOption) (*ProcessEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.Process/LogEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedProcessServer) LogProcess(ctx context.Context, req *ProcessEntry) (*ProcessEntryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LogProcess not implemented")
}
func (*UnimplementedProcessServer) LogEvent(ctx context.Context, req *ProcessEvent) (*ProcessEventResponse, error) {
